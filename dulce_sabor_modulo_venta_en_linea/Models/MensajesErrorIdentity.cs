...
namespace dulce_sabor_modulo_venta_en_linea.Models
{
    public class MensajesErrorIdentity : IdentityErrorDescriber
    {
        ...
        public override IdentityError LoginAlreadyAssociated() { return new IdentityError { Code = nameof(LoginAlreadyAssociated), Description = "Un usuario con ese número ya existe." }; }
        public override IdentityError InvalidUserName(string userName) { return new IdentityError { Code = nameof(InvalidUserName), Description = $"El número '{userName}' es inválido. Solo puede contener números." }; }
        ...
        public override IdentityError DuplicateUserName(string userName) { return new IdentityError { Code = nameof(DuplicateUserName), Description = $"El número '{userName}' ya existe, por favor ingrese un nombre diferente." }; }
